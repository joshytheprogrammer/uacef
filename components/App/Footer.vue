<template>
  <div class="w-full bg-white py-8 px-4 sm:px-8 md:px-12 lg:px-28 lg:py-32  flex items-center justify-between">
    <div class="">
      <NuxtLink class="flex items-center pb-4" to="/#">
        <img class="w-32 pr-4" src="~/assets/img/uacef-logo.png" alt="UACEF Logo">
